...
export class Mig1011618387697236 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "match" ("matchId" uuid NOT NULL DEFAULT uuid_generate_v4(), "match_history_id" uuid, "teamId" uuid, CONSTRAINT "PK_7dd6d1fec38b24c30d6907d51e2" PRIMARY KEY ("matchId"))`);
