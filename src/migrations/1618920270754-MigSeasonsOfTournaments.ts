...
export class MigSeasonsOfTournaments1618920270754
  implements MigrationInterface {
  name = 'MigSeasonsOfTournaments1618920270754';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "season" ("seasonId" uuid NOT NULL DEFAULT uuid_generate_v4(), "pre_season_init_date" TIMESTAMP WITH TIME ZONE, "pre_season_final_date" TIMESTAMP WITH TIME ZONE, "official_season_init_date" TIMESTAMP WITH TIME ZONE, "official_season_final_date" TIMESTAMP WITH TIME ZONE, "tournamentTournamentId" uuid, CONSTRAINT "PK_127d97d7a0dadc7b35c2a360ef9" PRIMARY KEY ("seasonId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tournament" ("tournamentId" uuid NOT NULL DEFAULT uuid_generate_v4(), "tournament_name" character varying NOT NULL, "invitation_code" character varying NOT NULL, "adminId" uuid, CONSTRAINT "PK_fbec894d68c361a6aa2db4cfd4e" PRIMARY KEY ("tournamentId"))`,
    );
    await queryRunner.query(
