...
export class MigContractState1619021756092 implements MigrationInterface {
    name = 'MigContractState1619021756092'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "coach" ("coachId" uuid NOT NULL DEFAULT uuid_generate_v4(), "playerId" uuid NOT NULL, CONSTRAINT "REL_3c0ccc147b1b82b02090328afa" UNIQUE ("playerId"), CONSTRAINT "PK_98a0f2bec36b724f8555091c7ed" PRIMARY KEY ("coachId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "match" ("matchId" uuid NOT NULL DEFAULT uuid_generate_v4(), "finalized" boolean NOT NULL DEFAULT false, "match_history_id" uuid, "teamId" uuid, CONSTRAINT "PK_7dd6d1fec38b24c30d6907d51e2" PRIMARY KEY ("matchId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team" ("teamId" uuid NOT NULL DEFAULT uuid_generate_v4(), "team_name" character varying NOT NULL, "available" boolean NOT NULL DEFAULT true, "coachId" uuid, "tournamentTournamentId" uuid, CONSTRAINT "PK_e3c1e347fd4f0813cc7b2e2115b" PRIMARY KEY ("teamId"))`);
        await queryRunner.query(`CREATE TABLE "device" ("deviceId" uuid NOT NULL DEFAULT uuid_generate_v4(), "fcm_token" character varying NOT NULL, "active" boolean NOT NULL DEFAULT true, "userId" uuid NOT NULL, CONSTRAINT "UQ_3c4ed5801431490290b69c78c62" UNIQUE ("fcm_token"), CONSTRAINT "PK_6fe2df6e1c34fc6c18c786ca26e" PRIMARY KEY ("deviceId"))`);
        ...
        await queryRunner.query(`CREATE TYPE "user_table_role_enum" AS ENUM('ADMIN', 'PLAYER', 'SPECTATOR', 'COACH', 'REFEREE')`);
        await queryRunner.query(`CREATE TABLE "user_table" ("userId" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT 'NOW()', "updatedAt" TIMESTAMP DEFAULT now(), "role" "user_table_role_enum" NOT NULL, "profilePath" character varying NOT NULL DEFAULT 'profile.jpg', "name" character varying NOT NULL, "lastname" character varying NOT NULL, "available" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_517f1a649ad49fa1435e54b0d5f" UNIQUE ("email"), CONSTRAINT "PK_19d4cfd316c838a502c6bc08090" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE TYPE "player_contractstate_enum" AS ENUM('FREE', 'SIGNED')`);
        await queryRunner.query(`CREATE TABLE "player" ("playerId" uuid NOT NULL DEFAULT uuid_generate_v4(), "contractState" "player_contractstate_enum" NOT NULL DEFAULT 'FREE', "teamId" uuid, "userId" uuid, CONSTRAINT "REL_7687919bf054bf262c669d3ae2" UNIQUE ("userId"), CONSTRAINT "PK_ee365af3f201a00d9a917bc45b0" PRIMARY KEY ("playerId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "referee" ("refereeId" uuid NOT NULL DEFAULT uuid_generate_v4(), "playerId" uuid, CONSTRAINT "REL_118d36f8998206463ffdb6c13b" UNIQUE ("playerId"), CONSTRAINT "PK_32969459d263cd8038437276f15" PRIMARY KEY ("refereeId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "admin" ("adminId" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, CONSTRAINT "REL_f8a889c4362d78f056960ca6da" UNIQUE ("userId"), CONSTRAINT "PK_abce4cc3fe598f242ab45e529b6" PRIMARY KEY ("adminId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_ef490329591cb46d6d8f77f7959" FOREIGN KEY ("tournamentTournamentId") REFERENCES "tournament"("tournamentId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "device" ADD CONSTRAINT "FK_9eb58b0b777dbc2864820228ebc" FOREIGN KEY ("userId") REFERENCES "user_table"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "FK_cfd8e81fac09d7339a32e57d904" FOREIGN KEY ("userId") REFERENCES "user_table"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notification" ADD CONSTRAINT "FK_1ced25315eb974b73391fb1c81b" FOREIGN KEY ("userId") REFERENCES "user_table"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users_auth_forgotten_passwords" ADD CONSTRAINT "FK_7122a91f7ca674db93166e14d4b" FOREIGN KEY ("userId") REFERENCES "user_table"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "player" ADD CONSTRAINT "FK_7687919bf054bf262c669d3ae21" FOREIGN KEY ("userId") REFERENCES "user_table"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "player" ADD CONSTRAINT "FK_e85150e7e8a80bee7f2be3adab0" FOREIGN KEY ("teamId") REFERENCES "team"("teamId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "player_stats" ADD CONSTRAINT "FK_e8ecfb1db35dff1acfac9533922" FOREIGN KEY ("seasonId") REFERENCES "season"("seasonId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "referee" ADD CONSTRAINT "FK_118d36f8998206463ffdb6c13bb" FOREIGN KEY ("playerId") REFERENCES "player"("playerId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "referee" DROP CONSTRAINT "FK_118d36f8998206463ffdb6c13bb"`);
        ...
        await queryRunner.query(`ALTER TABLE "team" DROP CONSTRAINT "FK_ef490329591cb46d6d8f77f7959"`);
        ...
        await queryRunner.query(`DROP TYPE "user_table_role_enum"`);
